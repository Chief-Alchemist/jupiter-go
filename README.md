...
[![GoDoc](https://pkg.go.dev/badge/github.com/Chief-Alchemist/jupiter-go?status.svg)](https://pkg.go.dev/github.com/Chief-Alchemist/jupiter-go?tab=doc)
[![Go Report Card](https://goreportcard.com/badge/github.com/Chief-Alchemist/jupiter-go)](https://goreportcard.com/report/Chief-Alchemist/jupiter-go)
...
```bash
go get github.com/Chief-Alchemist/jupiter-go
```
